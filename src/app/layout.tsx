          ...
          <div className="container mx-auto px-4">
            <ul className="flex justify-center gap-8 text-sm text-gray-600 py-4">
              <li className="flex items-center gap-2">
                ...
                <Link href="/menuLocais" className="hover:text-[#D85E1B]">Pesquisar tudo</Link>
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <Link href="/menuLocais" className="hover:text-[#D85E1B]">O que fazer</Link>
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <Link href="/" className="hover:text-[#D85E1B]">Agenda</Link>
              </li>
            </ul>
          </div>
        </nav>
